...
namespace sfacd
{
    ...
    public:
        ...
        TEST_METHOD(test_is_equal_approx)
        {
            ...
            Assert::IsTrue(
                plane3(vector3{1.0f, 0.0f, 0.0f}, 2.0f)
                .is_equal_approx(
                    plane3(vector3{1.0f, 0.0f, 0.0f}, 2.0f)));
            Assert::IsFalse(
                plane3(vector3{1.0f, 0.0f, 0.0f}, 2.0f)
                .is_equal_approx(
                    plane3(vector3{1.0f, 0.0f, 0.0f}, 2.1f)));
        }
        ...
        TEST_METHOD(test_distance_to)
        {
            Assert::AreEqual(
                -1.0f,
                plane3(vector3{0.0f, 1.0f, 0.0f}, 1.0f)
                .distance_to(vector3{0.0f, 0.0f, 0.0f}));
            Assert::AreEqual(
                0.0f,
                plane3(vector3{0.0f, 1.0f, 0.0f}, 1.0f)
                .distance_to(vector3{0.0f, 1.0f, 0.0f}));
            Assert::AreEqual(
                1.0f,
                plane3(vector3{0.0f, 1.0f, 0.0f}, 1.0f)
                .distance_to(vector3{0.0f, 2.0f, 0.0f}));
        }
        ...
        TEST_METHOD(test_side)
        {
            ...
            Assert::AreEqual(
                0,
                plane3(vector3{0.0f, 1.0f, 0.0f}, 1.0f)
                .side(vector3{0.0f, 1.0f, 0.0f}));
            Assert::AreEqual(
                1,
                plane3(vector3{0.0f, 1.0f, 0.0f}, 1.0f)
                .side(vector3{0.0f, 2.0f, 0.0f}));
        }

        TEST_METHOD(test_project)
        {
            Assert::IsTrue(
                vector3{0.0f, 1.0f, 0.0f} == plane3(vector3{0.0f, 1.0f, 0.0f}, 1.0f)
                .project(vector3{0.0f, 0.0f, 0.0f}));
            Assert::IsTrue(
                vector3{0.0f, 1.0f, 0.0f} == plane3(vector3{0.0f, 1.0f, 0.0f}, 1.0f)
                .project(vector3{0.0f, 1.0f, 0.0f}));
            Assert::IsTrue(
                vector3{0.0f, 1.0f, 0.0f} == plane3(vector3{0.0f, 1.0f, 0.0f}, 1.0f)
                .project(vector3{0.0f, 2.0f, 0.0f}));
        }
